...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="dashboard.php" class="brand-link">
            <i class="fas fa-user-shield brand-image img-circle elevation-3" style="opacity: .8; font-size: 2rem;"></i>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="create_user.php" class="nav-link <?php echo $active_page == 'create_user' ? 'active' : ''; ?>">
